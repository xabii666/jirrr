...
struct ImDrawList
{
    ...
    IMGUI_API void  AddCircleCross(ImVec2 center, float radius, ImU32 col, float thickness, bool filled, ImU32 cross_col, float cross_thickness);
...
extern bool IsPointOverAnyWindow(ImVec2 point);